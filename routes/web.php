...
=======
    Route::get('/admin/gradeLevel/addSubjects/{id}', [GradeLevelController::class, 'display_subjects_for_grade_level'])->name('grade_level.display_subjects_for_grade_level');
