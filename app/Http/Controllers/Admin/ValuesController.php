    ...
    public function index()
    {
        if(request()->ajax())
        {
            ...
            ->addColumn('actions', function($row){
                    ...
                    $btn .= ' <a href="javascript:void(0)" data-toggle="tooltip"  data-id="'.$row->id.'" data-original-title="Edit" class="edit btn btn-secondary btn-sm " onclick="assign_description('.$row->id.')"><i class="fas fa-plus-circle"></i> Add Statement</a> |';
