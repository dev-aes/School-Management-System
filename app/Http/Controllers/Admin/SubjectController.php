        ...
        if(request()->ajax()) {
            return DataTables::of(Subject::all())
                ...
                ->addColumn('actions', function($row) {
                    ...
                    $btn = ' <a href="javascript:void(0)" data-toggle="tooltip"  data-id="'.$row->id.'" data-original-title="Edit" class="edit btn btn-secondary btn-sm editSubject rounded-cir" onclick="editSubject('.$row->id.')"><i class="fas fa-edit"></i> Edit</a> |';
